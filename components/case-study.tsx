  ...
  return (
    <div className={dark ? 'site dark' : 'site'}>
      ...
      <main className="case-study">
        ...
        {landscapeImage ? <img className="placeholder landscape case-hero-image" src={landscapeImage} alt={landscapeAlt} /> : <div className="placeholder landscape">Landscape image placeholder</div>}
