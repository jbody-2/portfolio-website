  ...
  return (
    <div className={dark ? 'site dark' : 'site'}>
      ...
      <main className="case-study">
        ...
        <header className="case-header"><p className="case-company">Independent case study</p><h1>{name}</h1><div className="case-meta"><div><span>Role</span><strong>Design direction, Product design</strong></div><div><span>Deliverables</span><strong>Strategy, UX, Visual system</strong></div><div><span>Timeline</span><strong>12 weeks · 2024</strong></div></div><p className="case-intro">A thoughtful digital experience designed to make complex work feel simple, clear, and distinctly human.</p></header>
